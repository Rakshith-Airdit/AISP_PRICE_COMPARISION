sap.ui.define(
  ...
  function (
    ...
    return Controller.extend(
      "com.pricecomp.pricecomp.controller.CreateMaterialRFQ",
      {
        onInit: function () {
          this.router = this.getOwnerComponent().getRouter();
          this.router
            .getRoute("RouteCreateMaterialRFQ")
        ...
        onRouteMatched: function () {
          ...
          this.byId("idRFQBasicDetails").setBindingContext(
        ...
        onMaterialDescriptionChange: function (event) {
          ...
          const path =
            event.getSource()._oFactory.oTextArrangementDelegate
              .sBindingContextPath;
          ...
          model.read("/ZC_AISP_MATERIALDETAILS_VH", {
            ...
            success: function (data) {
              if (data.results.length > 0) {
                ...
                context.setProperty(
                  "Description",
                  selectedMaterial.Maktx || "Group"
                );
                context.setProperty(
                  "LotType",
                  selectedMaterial.MaterialGroup || "Group"
                );
                context.setProperty(
                  "UnitOfMeasure",
        ...
        buildRFQPayload: function (headerData) {
          // Build items payload
          const itemsPayload = this.byId("idRFQItemsTable")
            .getItems()
          ...
          const suppliersPayload = this.byId("suppliersTable")
            .getItems()
